<!-- Context: project-intelligence/nav | Priority: high | Version: 1.1 | Updated: 2026-02-17 -->
...
├── technical-domain.md        # Stack, architecture, code patterns, 📂 codebase refs
...
| Understand the "how" | `technical-domain.md` | Stack, architecture, working code examples |
| Find implementation | `technical-domain.md` → 📂 Codebase References | Links to actual code files |
