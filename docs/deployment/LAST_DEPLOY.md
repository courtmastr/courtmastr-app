...
- Deployed commit: `873d213` (`feat: interactive Excel tournament backup export (#84)`)
- Release notes:
...
- Deploy log artifact from deploy-log run:
  - `docs/debug-kb/_artifacts/2026-04-18-13-02-08.npm-run-build-firebase-deploy-project-production.log`
...
- Date: 2026-04-18 08:03 CDT
- Commit: `873d2137b1b117748a461249d2392f2809cb4a7a`
- Message: `feat: interactive Excel tournament backup export (#84)`
