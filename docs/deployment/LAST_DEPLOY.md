...
- Date: 2026-04-11 18:39 CDT
- Release ID: `v2.2.0`
- Package version: `2.2.0`
- Deployed branch: `master`
- Deployed commit: `8a972ce` (`fix: stop service worker from caching Firestore streams, add reviews index`)
- Release notes:
...
- Deploy log artifact from deploy-log run:
  - `docs/debug-kb/_artifacts/2026-04-11-23-38-41.npm-run-build-firebase-deploy-project-production.log`
...
- Date: 2026-04-11 18:39 CDT
- Commit: `8a972cefcc8120bac1aff257dc91ddf97368507e`
- Message: `fix: stop service worker from caching Firestore streams, add reviews index`
