...
- Date: 2026-04-18 09:36 CDT
- Release ID: `v2.18.0`
- Package version: `2.18.0`
- Deployed branch: `master`
- Deployed commit: `b9cf9e1` (`fix: add walkover to shared manual scoring dialog (#86)`)
- Release notes:
...
- Deploy log artifact from deploy-log run:
  - `docs/debug-kb/_artifacts/2026-04-18-14-35-24.npm-run-build-firebase-deploy-project-production.log`
...
- Date: 2026-04-18 09:36 CDT
- Commit: `b9cf9e1b4f002a4897dd814395ece90634f8f028`
- Message: `fix: add walkover to shared manual scoring dialog (#86)`
