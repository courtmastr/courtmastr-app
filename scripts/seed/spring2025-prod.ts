/**
 * Spring Classic 2025 Tournament Seed - Production
 *
 * Seeds a second tournament to production.
 * Run: npm run seed:spring2025:prod
 */
...
async function main(): Promise<void> {
  console.log('\n' + '='.repeat(64));
  console.log('  Seed: Spring Classic 2025 (Production)');
